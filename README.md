...
SQL语言|MySQL|ORACLE|PowerDesigner|MongoDB|分布式数据库|[Redis缓存](https://github.com/stevenli91748/JAVA-Architecture/blob/master/Tools%20and%20Middleware/Redis)|Mybatis|
---|---|---|---|---|---|---|---|
