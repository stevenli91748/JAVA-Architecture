...
# [一个典型的SpringMVC请求流程如图所示](https://www.javaguides.net/2020/07/how-spring-mvc-works-internally.html)
...
# 有用的参考
## 注解
* [@RequiredArgsConstructor(onConstructor =@_(@Autowired))代替@AutoWired注解](https://www.cxyzjd.com/article/a88328734/108147670)
