...
## 学习类
## 文章类
csdn|掘金|博客园|infoQ|OSCHINA---开源中国|
## 求职类
leetcode|
...
[java干货的视频---很好](https://space.bilibili.com/244056686/video?tid=0&page=3&keyword=&order=pubdate)|
---|

[廖雪峰的官方网站](https://www.liaoxuefeng.com/wiki/1022910821149312)|[三歪教你学Java](https://gitee.com/zhongfucheng/Java3y#https://mp.weixin.qq.com/s?__biz=MzI4Njg5MDA5NA==&mid=2247485115&idx=1&sn=5d269f40f820c82b460993669ca6242e&chksm=ebd747badca0ceac9953f82e08b1d1a49498ebd4af77ec5d628a0682bb9f0ac5ab347411f654&token=1741918942&lang=zh_CN###rd)|
---|---|
...
[java核心知识整理](https://www.kancloud.cn/imnotdown1019/java_core_full/1004074)|[疯狂创客圈](https://www.cnblogs.com/crazymakercircle/p/9904544.html)|
---|---|

[木九天](https://my.oschina.net/mdxlcj?tab=newest&catalogId=5781789)|
---|
...
[VS Code](https://github.com/stevenli91748/Frontend/blob/master/Visual%20Studio%20Code/README.md)|[Alibaba Java诊断利器Arthas](https://github.com/alibaba/arthas)|[静态代码分析工具](https://weread.qq.com/web/reader/71032d60719ad5af7104ca2kaab325601eaab3238922e53)|
---|---|---|
 ...
 * [别在重复造轮子了，几个值得应用到项目中的 Java 开源库送给你](https://juejin.im/post/5edd9a33e51d45784635b1a8)
 ...
 [Java魔法类：Unsafe应用解析---提供的API大致可分为内存操作、CAS、Class相关、对象操作、线程调度、系统信息获取、内存屏障、数组操作等几类，如直接访问系统内存资源、自主管理内存资源等](https://tech.meituan.com/2019/02/14/talk-about-java-magic-class-unsafe.html)|[JMH---针对Java代码做基准测试的工具库]()|
 ---|---|
...
[%序列化与反序列化]:https://github.com/stevenli91748/JAVA-Architecture/blob/master/Java%20fundamental/序列化与反序列化.md
