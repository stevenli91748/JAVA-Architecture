...
[Java 集合框架详解---非常好](https://www.runoob.com/java/java-collections.html)|[Java Collections Tutorial sample](https://www.javaguides.net/2018/08/collections-framework-in-java.html)|[Learn Java Collections with Examples](https://www.sourcecodeexamples.net/p/learn-java-collections-with-examples.html)|[Learn Java Collections with Examples](https://www.sourcecodeexamples.net/p/learn-java-collections-with-examples.html)|
---|---|---|---|
...
* 5 Aggregate Operations(Streams)
...
* 6 Collections Helper/Utility Classes
...
* [7 Convert Collections Examples](https://www.javaguides.net/p/java-collections-tutorial.html)
...
* [8 Collections Difference](https://www.javaguides.net/p/java-collections-tutorial.html)
...
* [9 Collections Examples](https://www.javaguides.net/p/java-collections-tutorial.html)  
