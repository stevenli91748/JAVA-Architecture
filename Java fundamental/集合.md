...
# Java 数据结构---以下这些类是传统遗留的，在Java2中引入了一种新的框架-集合框架(Collection)
  * [枚举（Enumeration）](https://www.runoob.com/java/java-enumeration-interface.html)
  * [位集合（BitSet）](https://www.runoob.com/java/java-bitset-class.html)
  * [向量（Vector）](https://www.runoob.com/java/java-vector-class.html)
  * [栈（Stack）](https://www.runoob.com/java/java-stack-class.html)
  * [字典（Dictionary）](https://www.runoob.com/java/java-dictionary-class.html)
  * [哈希表（Hashtable）](https://www.runoob.com/java/java-hashTable-class.html)
  * [属性（Properties）](https://www.runoob.com/java/java-properties-class.html)


# Java 集合(Collection)---Java 集合可分为 Collection 和 Map 两种体系
