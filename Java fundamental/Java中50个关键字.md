...
### synchronized
* [synchronized底层原理（从Java对象头说到即时编译优化）](https://blog.csdn.net/lpf463061655/article/details/105149322)
* [从JVM的角度分析Synchronize 关键字原理](https://www.bilibili.com/read/cv706505)
