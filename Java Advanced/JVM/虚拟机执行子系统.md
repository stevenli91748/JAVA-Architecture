...
#### 链接
   ...
   * 直接引用
   ...
   解析动作主要针对类或接口 字段 类方法 接口方法 方法类型 方法句柄 和调用点限定符7类符号引用
   
   <details>
   <summary>类或接口</summary>
   ...
   <details>
   <summary>方法类型</summary>


   </details>

   <details>
   <summary>方法句柄</summary>


   </details>

   <details>
   <summary>调用点限定符</summary>
...
#### 初始化
  ...
  对一个类的**主动引用**， 除此之外，所有引用类的方式都不会触发初始化，称为**被动引用**
