...
<summary>Synchronized 关键字</summary>
  ...
  synchronized是在JVM层面的，concurrentAPI是在代码层面
  ...
  synchronized 块是Java 提供的一种原子性内置锁， Java 中的每个对象都可以把它当作一个同步锁来使用， 这些Java 内置的使用者看不到的锁被称为内部锁，也叫作监视器锁。
...
<details>
<summary>CAS机制是什么，如何解决ABA问题</summary>

  https://blog.csdn.net/riemann_/article/details/98353022
