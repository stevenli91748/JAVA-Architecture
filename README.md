 ...
 * [别在重复造轮子了，几个值得应用到项目中的 Java 开源库送给你](https://juejin.im/post/5edd9a33e51d45784635b1a8)
 ...
 [Java魔法类：Unsafe应用解析---提供的API大致可分为内存操作、CAS、Class相关、对象操作、线程调度、系统信息获取、内存屏障、数组操作等几类，如直接访问系统内存资源、自主管理内存资源等](https://tech.meituan.com/2019/02/14/talk-about-java-magic-class-unsafe.html)|
 ---|
